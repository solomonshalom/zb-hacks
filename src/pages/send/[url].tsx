...
const Send = () => {
  ...
  return (
    <>
      <Head>
        <title>Send project: {data.hackathon.name} - Zerobase</title>
      </Head>
      <div className="mx-auto flex h-screen flex-col items-center justify-center px-6">
        {data.hackathon.is_finished ? (
          <div className="flex flex-col items-center justify-center">
            <h1 className="mb-3 text-center text-3xl font-medium">
              🎉 This hackathon has finished
            </h1>
            <p className="mb-3 text-center text-gray-400">
              You can no longer submit projects to this hackathon
            </p>
